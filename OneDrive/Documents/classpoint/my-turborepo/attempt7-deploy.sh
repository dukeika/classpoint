...
echo "=== DEPLOYMENT ATTEMPT 7 - Standard Next.js Build ==="
echo "Commit: 3e1dc14 (Remove standalone mode, use pnpm start)"
echo ""

# Step 1: Wait for service deletion
echo "Step 1: Waiting for service deletion..."
for i in {1..20}; do
  sleep 5
...
# Step 2: Create App Runner service with latest image
